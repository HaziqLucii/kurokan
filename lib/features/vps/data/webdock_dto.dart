...
class ResourceUsageMetricStatusDTO {
  ...
  factory ResourceUsageMetricStatusDTO.fromJson(Map<String, dynamic> json) =>
      ResourceUsageMetricStatusDTO(
...
class ResourceUsageStatusDTO {
  ...
  factory ResourceUsageStatusDTO.fromJson(Map<String, dynamic> json) =>
      ResourceUsageStatusDTO(
        cpu: ResourceUsageMetricStatusDTO.fromJson(
          json['cpu'] as Map<String, dynamic>,
        ),
        memory: ResourceUsageMetricStatusDTO.fromJson(
          json['memory'] as Map<String, dynamic>,
        ),
        disk: ResourceUsageMetricStatusDTO.fromJson(
          json['disk'] as Map<String, dynamic>,
        ),
        network: ResourceUsageMetricStatusDTO.fromJson(
...
class InstantServerMetricsDTO {
  ...
  factory InstantServerMetricsDTO.fromJson(Map<String, dynamic> json) {
    ...
    final procSampling =
        processes?['latestProcessesSampling'] as Map<String, dynamic>?;

    return InstantServerMetricsDTO(
      resourceUsageStatus: ResourceUsageStatusDTO.fromJson(
        json['resourceUsageStatus'] as Map<String, dynamic>,
      ),
      ...
      memorySampledAt: DateTime.parse(
        memSampling?['timestamp'] as String,
      ).toLocal(),
